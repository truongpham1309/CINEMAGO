                           ...
                           <div className="check-area">
                              {genres?.map((g, i) => (
                                 <div onClick={() => handleGenreFilterChange(g)} key={i} className="form-group m-0">
                                    ...
                                    <label className="pt-1" htmlFor="lang1">
                                       {g}
                                    </label>
                                 </div>
                              ))}
                              ...
                              <div className="left">
                                 ...
                                 <div className="">
                                    <div className="nice-select">
                                       ...
                                       <ul className="list">
                                          <li data-value="all" onClick={() => handleStatusFilterChange("all")} className="option text-black focus selected">
                                             Tất cả
                                          </li>
                                          <li data-value="Coming Soon" onClick={() => handleStatusFilterChange("Coming Soon")} className="option text-black focus">
                                             Phim sắp chiếu
                                          </li>
                                          <li data-value="Currently Showing" onClick={() => handleStatusFilterChange("Currently Showing")} className="option text-black focus">
                                             Phim đang chiếu
                                          </li>
                                       </ul>
                                    </div>
                           ...
                           <div className="tab-item active">
                              <div className="row mb-10 align-items-strech">
                                 {filterMovies.map((movieid, index) => {
                                    ...
                                    return movie ? <ItemsMovieComponent className="col-md-6 col-lg-4" key={index} movie={movie} /> : null;
                                 })}
                              </div>
                           </div>
                        </div>
