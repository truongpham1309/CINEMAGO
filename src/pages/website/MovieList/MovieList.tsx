...
const MovieList = () => {
  ...
  return (
    <>
      <div className="search-tab bg_img" data-background={bgTicket01}>
          ...
          <div className="col-lg-6 mb-20">
            <ul className="tab-menu ticket-tab-menu">
              ...
              <li>
                <div className="tab-thumb">
                  <img
                    src="E:\DATN\CINEMASWAY\src\assets\images\ticket\ticket-tab02.png"
                    alt="ticket"
                  />
                </div>
                <span>events</span>
                            ...
                            <div className="movie-grid">
                              ...
                              <div className="movie-content bg-one">
                                ...
                                <ul className="movie-rating-percent">
                                  <li>
                                    <div className="thumb">
                                      <span>{movies.duration}</span> {/*map thời gian*/}
                                    </div>
                                  </li>
                                </ul>
                              </div>
