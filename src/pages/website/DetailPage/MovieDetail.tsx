            ...
            <section className="details-banner bg_img">
                <div className="container">
                    <div className="details-banner-wrapper">
                        ...
                        <ModalVideo channel='youtube' isOpen={showTrailer}
                                    videoId={extractVideoId(movies?.trailer || "") || ""}
                        ...
                        <div className="details-banner-content offset-lg-3">
                            ...
                            <span
                                className="button ml-2">{movies?.rated === "C18" ? "Trên 18 tuổi" : (movies?.rated === "C16" ? "Trên 16 tuổi" : (movies?.rated === "C13" ? "Trên 13 tuổi" : "Mọi lứa tuổi"))}</span>
